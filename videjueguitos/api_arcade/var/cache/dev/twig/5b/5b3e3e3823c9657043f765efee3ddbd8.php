...
class __TwigTemplate_800a9566d3475b6f27b9a0839ee8bd91 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["juego"]) {
            ...
            echo "</td>
                <td>";
            // line 26
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["juego"], "votosPositivos", [], "any", false, false, false, 26), "html", null, true);
            echo "</td>
                <td>";
            // line 27
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["juego"], "votosNegativos", [], "any", false, false, false, 27), "html", null, true);
            echo "</td>
                <td>";
            // line 28
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["juego"], "imagen", [], "any", false, false, false, 28), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 30
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_juego_show", ["id" => twig_get_attribute($this->env, $this->source, $context["juego"], "id", [], "any", false, false, false, 30)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 31
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_juego_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["juego"], "id", [], "any", false, false, false, 31)]), "html", null, true);
            echo "\">edit</a>
                </td>
            </tr>
        ";
    ...
    <table class=\"table\">
        ...
        {% for juego in juegos %}
            <tr>
                ...
                <td>{{ juego.imagen }}</td>
                <td>
                    <a href=\"{{ path('app_juego_show', {'id': juego.id}) }}\">show</a>
...
{% endblock %}
", "juego/index.html.twig", "C:\\Visual\\proyecto\\proyecto_skills_2019\\videjueguitos\\api_arcade\\templates\\juego\\index.html.twig");
    }
}
