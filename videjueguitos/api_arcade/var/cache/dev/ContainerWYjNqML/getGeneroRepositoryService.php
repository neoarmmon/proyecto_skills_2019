 ...
 */
class getGeneroRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\GeneroRepository' shared autowired service.
     *
     * @return \App\Repository\GeneroRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GeneroRepository.php';

        return $container->privates['App\\Repository\\GeneroRepository'] = new \App\Repository\GeneroRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
