 ...
 */
class getRolesUsuarioRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RolesUsuarioRepository' shared autowired service.
     *
     * @return \App\Repository\RolesUsuarioRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RolesUsuarioRepository.php';

        return $container->privates['App\\Repository\\RolesUsuarioRepository'] = new \App\Repository\RolesUsuarioRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
