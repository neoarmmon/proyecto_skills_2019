 ...
 */
final class Version20240221084629 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE juegos (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(40) NOT NULL, descripcion VARCHAR(125) DEFAULT NULL, votos_positivos INT DEFAULT NULL, votos_negativos INT DEFAULT NULL, imagen VARCHAR(45) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
