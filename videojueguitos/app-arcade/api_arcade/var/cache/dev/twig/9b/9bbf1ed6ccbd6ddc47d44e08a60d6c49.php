...
{% block body %}
    {% if error %}
        <div>{{ error.messageKey|trans(error.mesageData,'security') }}</div>
    {% endif %}
...
{% endblock %}
", "login/index.html.twig", "C:\\Visual\\proyecto\\proyecto_skills_2019\\videjueguitos\\api_arcade\\templates\\login\\index.html.twig");
    }
}
